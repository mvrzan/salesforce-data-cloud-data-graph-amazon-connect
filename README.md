...
CLIENT_SECRET can be gathered from the Connect App within the Salesforce instance and it is labeled `Secret` once the Connected App is created.
...
CDP_INSTANCE_URL is the URL of your Salesforce instance.
